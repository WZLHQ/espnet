...
class ProxyESPnetASRModel(AbsESPnetModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # 1. Encoder
        encoder_out, encoder_out_lens, proxy_encoder_out, proxy_encoder_out_lens = self.encode(speech, speech_lengths)

        assert encoder_out.size(1)==proxy_encoder_out.size(1)
        ...
        if self.use_transducer_decoder:
            ...
            if self.ctc_weight != 1.0:
                loss_att, acc_att, cer_att, wer_att = self._calc_att_loss(
                    encoder_out, encoder_out_lens, proxy_encoder_out, proxy_encoder_out_lens, text, text_lengths
                )
    ...
    def encode(
        ...
        return encoder_out, encoder_out_lens, proxy_encoder_out, proxy_encoder_out_lens
